...
class Helpers{
	 ...
	 * @return integer
	 */
	public static function _getStartTime($day)
	{
	    $time = date('Y-m-d',$day);
	    $start = $time." 00:00:00";
	    return $start;
	 ...
	 * @return integer
	 */
	public static function _getEndTime($day)
	{
	    $time = date('Y-m-d',$day);
	    $end = $time." 23:59:59";
	    return $end;
	 ...
	 */
	public static function convertTimeElapsedAsText($iTime0, $iTime1 = 0)
	{
	...
	public static function cutStr($string,$start,$length,$encoding='utf-8') {
