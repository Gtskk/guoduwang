    ...
    <form action="{{ route('cpanel.login') }}" method="post">
        <div class="body bg-gray">
            ...
            <div class="form-group">
                <input type="text" name="login_attribute" class="form-control" placeholder="{{ lang(ucfirst($login_attribute)) }}"/>
            </div>
            <div class="form-group">
                <input type="password" name="password" class="form-control" placeholder="{{ trans('cpanel::users.password') }}"/>
            </div>
            <div class="form-group">
