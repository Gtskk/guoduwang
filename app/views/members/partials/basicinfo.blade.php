<div class="avatar">
	<a href="javascript:void(0);">
		<img id="avatar-src" src="{{ $member->image_url }}" class="img-thumbnail users-show-avatar" style="width: 206px;margin: 4px 4px 15px;min-height:190px">
	...
	<form id="avatarUpload" action="{{ route('upload_image') }}" class="dropzone">
		...
		<input type="hidden" name="_userid" value="{{ Request::segment(2) }}" />
	</form>
	@endif
</div>
